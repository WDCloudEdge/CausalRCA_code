        ...
        for simple in simples:
            ...
            for namespace in namespaces:
                all_data_ns = pd.read_csv(
                    base_dir + 'data/abnormal/hipster_chaos_2/' + root_cause_service + '/' + simple.dir + '/' + namespace + '/metrics/instance.csv')
            ...
            count = 0
            with open('MicroCERC/hipster/instance/' + simple.label + '.log', "a") as output_file:
